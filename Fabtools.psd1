...
AliasesToExport = @(
    'Assign-PowerBIWorkspaceToCapacity',
    'Assign-PowerBIGroupToCapacity',
    'Assign-FabGroupToCapacity',
    'Assign-FabricWorkspaceToCapacity',
