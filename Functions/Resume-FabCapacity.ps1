...
.DESCRIPTION
The Resume-FabCapacity function resumes a capacity. It supports multiple aliases for flexibility.
...
.EXAMPLE
Resume-FabCapacity -subscriptionID "your-subscription-id" -resourcegroupID "your-resource-group" -capacityID "your-capacity"
